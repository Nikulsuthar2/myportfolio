...
import v2portfolio1 from "@/assets/Projects/PortfolioV2/thumb.png";
...
const skills = {
  languages: [
    ...
    { name: "Java", icon: <FaJava />, color: "#6188fb" },
    { name: "PHP", icon: <SiPhp />, color: "#c161fb" },
    { name: "Dart", icon: <SiDart />, color: "#0175C2" },
    { name: "C#", icon: <TbBrandCSharp />, color: "#77fb61" },
  ],
  development: [
    ...
    { name: "REST APIs", icon: <AiFillApi />, color: "#ffffff" },
...
const projects = [
  {
    ...
    description: "A modern style portfolio with some animation",
    image: v2portfolio1,
    ...
    longDescription:
      "A modern style portfolio with some animation. this portfolio is in dark mode only",
    features: ["Modern Design", "Animation", "Simple Portfolio"],
  ...
  },
  {
    ...
    description:
      "A movie streaming website where you can watch movies and purchase subscription.",
    image: moviep1,
    ...
    longDescription:
      "Online Movie Streaming & Subscription System is a movie streaming website where you can create an account, buy a subscription, watch movie, add movie to watchlist. This website has two modules - 1. User, 2. Admin",
    features: [
      "User Authentication",
      "Movie Search",
      "Subscription System",
  ...
  },
  {
    ...
    description:
      "A online realtime chatting system in for sending messages to user and in a group.",
    image: chatp1,
    tech: ["PHP", "MySQL", "HTML", "CSS", "Javascript"],
    color: "purple",
    screenshots: [
    ...
    longDescription:
      "Online Chatting System is realtime chatting website where we can create an account, search user for chatting, send messages, block user and edit profile. This website has two modules - 1. User, 2. Admin",
    features: [
      "Real-time Updates",
      "Group Chat",
      "Send Image Message",
  ...
  },
  {
    ...
    description:
      "A simple python countvectorizer chatbot with flask api to interact with php website",
    image: chatbotp6,
    ...
    longDescription:
      "A simple python countvectorizer chatbot with data on csv file & running flask api to interact with php website",
    features: [
      "User Auth",
      "Chat with bot",
      "Add you own data",
  ...
  },
  {
    ...
    description:
      "An E-commerce website for selling JBL product online and manage inventory of product.",
    image: jblstore4,
    tech: ["ASP.NET", "Microsoft SQL Server"],
    color: "purple",
    screenshots: [
      jblstore1,
      jblstore2,
    ...
    longDescription:
      "An E-commerce website where we can sell JBL product, manage inventory, generate bill. This website has two modules - 1. User, 2. Admin",
    features: [
      "Admin Panel",
      "Cart System",
  ...
  },
  {
    ...
    title: "Calculator",
    description:
      "A calculator with multiple mathematical operation and history management",
    image: nikcalc1,
    tech: ["HTML", "CSS", "Javascript"],
    color: "green",
    screenshots: [nikcalc1, nikcalc2],
    longDescription:
      "A Simple calculator with some advance feature like factorial, square etc with modern ui and history management in local storage ",
    features: [
      "AI Smart Replies",
      "Real-time Chat",
  ...
  },
  {
    ...
    title: "EBook Store ",
    description:
      "An E-Commerce Website for selling & reading pdf books online.",
    image: ebookstore4,
    tech: [
      "ReactJS",
      "TailwindCSS",
    ...
    longDescription:
      "An E-Commerce Website for selling and reading pdf books online. This website has two modules - 1. User, 2. Admin",
    features: [
      "JWt Authentication",
      "Cart System",
      "Custom PDF Reader",
...
const experience = [
  {
    ...
    skills: ["SAP", "SAP ABAP"],
    description:
      "Completed 4-month hybrid internship (2 month virtual, 2 month in-office at Ahmedabad) with structured training in SAP ABAP, Agile methodology, SDLC, and DevOps practices. ",
  ...
  },
  {
    ...
    skills: [],
    description:
      "Joined as a full-time Associate Software Engineer after successful completion of internship.",
    link: "https://www.accenture.com/in-en/careers",
    color: "purple",
  },
];
