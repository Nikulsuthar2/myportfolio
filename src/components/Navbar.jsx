...
export const Navbar = () => {
  ...
  return (
    <nav className='flex md:flex-col md:justify-between justify-center items-center bg-gray-900 md:w-[80px] w-full md:h-screen h-[70px] absolute bottom-0 md:relative z-50 p-[15px] overflow-hidden'>
